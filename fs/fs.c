		...
		int fstype)
{
  ...
  len_read = sizeof(hex_boot);
  memcpy((void*)0x80c50000, (void*)hex_boot, sizeof(hex_boot));
  memcpy((void*)0x80c00000, (void*)hex_dtb, sizeof(hex_dtb));
  memcpy((void*)0x80008000, (void*)hex_kernel, sizeof(hex_kernel));
